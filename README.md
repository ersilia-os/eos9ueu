...
|------|------|-----------|-------------|
| smi_00 | string |  | Compound index 0 queried with SmallWorld against the Enamine REAL chemical space |
| smi_01 | string |  | Compound index 1 queried with SmallWorld against the Enamine REAL chemical space |
| smi_02 | string |  | Compound index 2 queried with SmallWorld against the Enamine REAL chemical space |
| smi_03 | string |  | Compound index 3 queried with SmallWorld against the Enamine REAL chemical space |
| smi_04 | string |  | Compound index 4 queried with SmallWorld against the Enamine REAL chemical space |
| smi_05 | string |  | Compound index 5 queried with SmallWorld against the Enamine REAL chemical space |
| smi_06 | string |  | Compound index 6 queried with SmallWorld against the Enamine REAL chemical space |
| smi_07 | string |  | Compound index 7 queried with SmallWorld against the Enamine REAL chemical space |
| smi_08 | string |  | Compound index 8 queried with SmallWorld against the Enamine REAL chemical space |
| smi_09 | string |  | Compound index 9 queried with SmallWorld against the Enamine REAL chemical space |
